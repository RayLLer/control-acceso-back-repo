...
export interface ApiCustomPermissiomCustomPermissiom
  extends Struct.CollectionTypeSchema {
  collectionName: 'custom_permissioms';
  info: {
    displayName: 'Custom Permission';
    pluralName: 'custom-permissioms';
...
export interface ApiCustomPermissionRoleCustomPermissionRole
  extends Struct.CollectionTypeSchema {
  collectionName: 'custom_permission_roles';
  info: {
    displayName: 'Custom Permission Role';
    pluralName: 'custom-permission-roles';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    custom_permissions: Schema.Attribute.Relation<
      'oneToMany',
      'api::custom-permissiom.custom-permissiom'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::custom-permission-role.custom-permission-role'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPagoPago extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    periodo_pagado: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    ultimoPeriodoPago: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::custom-permissiom.custom-permissiom': ApiCustomPermissiomCustomPermissiom;
      'api::custom-permission-role.custom-permission-role': ApiCustomPermissionRoleCustomPermissionRole;
